...
|      2 | `mass_messages`              | 63,411 | 15.40 MB | 📁 Small    |
...
*Detected potential foreign key relationships based on column naming patterns:*
  ...
  - `caption_bank`.`caption_id` → `active_caption_assignments`
  - `caption_bank`.`caption_id` → `caption_bank_staging`
  - `caption_bank`.`caption_id` → `caption_filter_audit_log`
  - `caption_bank`.`caption_id` → `caption_performance_tracking`

---

## 📊 Tables and Views in `of-scheduler-proj.eros_scheduling_brain` (28 total)
...
- **Last Modified**: 2025-10-26 05:13:17 UTC 📅 This Week
- **Description**: ETL job execution tracking for intelligent freshness checking
- **Total Rows**: 4 | **Size**: 0.00 MB 📄 Tiny
  - **Data Quality Metrics**:
    - Overall Completeness: 🟢 Excellent (100.0%)
      ████████████████████ 100.0%
    - **Field Completeness Analysis**:
      - `run_id`: 🟢 Excellent (100.0% complete, 4 unique values)
      - `job_name`: 🟢 Excellent (100.0% complete, 1 unique values)
      - `started_at`: 🟢 Excellent (100.0% complete, 4 unique values)
      - `completed_at`: 🟢 Excellent (100.0% complete, 4 unique values)
      - `status`: 🟢 Excellent (100.0% complete, 1 unique values)
...
- **Last Modified**: 2025-10-30 08:54:38 UTC 🆕 Yesterday
- **Total Rows**: 63,411 | **Size**: 15.40 MB 📁 Small
  - **Data Quality Metrics**:
...
--------------------  -----------  --------------------------------------------------  -------------------------  -------  ------------  --------------  -----------------
-5788621766284224202               wanna take a look at my pink tight pussy? 💦💦        2025-10-11 14:09:00+00:00  NULL            46506             341                  0
-4937094208303660578               are you busy rn? 👀 i want to take all this offf     2025-10-26 01:02:00+00:00  NULL            46958            1066                  0
 ...
 7132586371346723384               just dropped my new dildo vid🥵 get it now for 50%   2025-10-10 12:12:00+00:00  NULL            46409             131                  0
    ```
- **Schema** (10 columns):
| Name            | Type      | Mode     | Description   |
|-----------------|-----------|----------|---------------|
